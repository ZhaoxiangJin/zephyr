...
.. code-block:: console
   ...
   west ebpf build my_probe.c -o my_probe.bundle --auth ecdsa-p256-sha256 --signing-key probe_key.pem
...
Once built, a bundle is delivered as in-memory bytes to
:c:func:`ebpf_loader_load`. Direct application or test code owns the loader
handle for the lifetime of the loaded bundle.
