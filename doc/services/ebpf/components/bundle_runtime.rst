...
* :zephyr_file:`subsys/ebpf/bundle/bundle.c`
...
:zephyr_file:`subsys/ebpf/loader/internal.h`.
...
.. list-table::
   ...
   * - 0x10
     - 4
     - ``ttl_ms``
     - Reserved for a future auto-unload timer. Accepted and ignored by the
       current runtime; builders may emit any value.
   * - 0x14
     - 4
     - ``bundle_name_offset``
