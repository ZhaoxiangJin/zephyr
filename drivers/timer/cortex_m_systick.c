 ...
 */
void z_system_timer_lpm_enter(uint64_t max_lpm_time_us)
{
...
uint64_t z_system_timer_lpm_exit(void)
{
	/**
...
void sys_clock_set_timeout(int32_t ticks, bool idle)
{
	...
	if (idle) {
		 ...
		 */
		z_system_timer_lpm_enter(timeout_us);
...
void sys_clock_idle_exit(void)
{
	...
	if (timeout_idle) {
		 ...
		 */
		idle_timer_us = z_system_timer_lpm_exit();
