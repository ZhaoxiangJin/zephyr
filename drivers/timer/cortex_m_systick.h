...
#define z_cms_lptim_hook_on_lpm_entry z_system_timer_lpm_enter __DEPRECATED_MACRO
#define z_cms_lptim_hook_on_lpm_exit z_system_timer_lpm_exit __DEPRECATED_MACRO
