...
/**
 * @file
 * @brief eBPF low-level instruction opcode definitions.
 * @ingroup ebpf
 */

#ifndef ZEPHYR_INCLUDE_EBPF_INSN_BASIC_H_
#define ZEPHYR_INCLUDE_EBPF_INSN_BASIC_H_
...
/** @brief Instruction class selectors in bits 0 through 2 of the opcode. */
...
/** @brief ALU source selector in bit 3 of ALU, ALU64, or JMP opcodes. */
#define EBPF_SRC_IMM		0x00U
#define EBPF_SRC_REG		0x08U

/** @brief ALU operation selectors in bits 4 through 7 of ALU and ALU64 opcodes. */
...
/** @brief Jump operation selectors in bits 4 through 7 of JMP opcodes. */
...
/** @brief Memory access size selectors in bits 3 and 4 of load/store opcodes. */
#define EBPF_SIZE_W		0x00U
#define EBPF_SIZE_H		0x08U
#define EBPF_SIZE_B		0x10U
#define EBPF_SIZE_DW		0x18U

/** @brief Memory access mode selector in bits 5 through 7 of load/store opcodes. */
#define EBPF_MODE_MEM		0x60U

/** @brief 64-bit ALU composed opcodes. */
...
/** @brief 32-bit ALU composed opcodes. */
...
/** @brief Memory-access composed opcodes. */
...
/** @brief Bit mask for extracting the instruction class from an encoded opcode. */
#define EBPF_CLASS_MASK		0x07U
/** @brief Return the instruction class bits from one encoded opcode. */
...
#endif /* ZEPHYR_INCLUDE_EBPF_INSN_BASIC_H_ */